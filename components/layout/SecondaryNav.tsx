...
const SecondaryNav = () => {
  return (
    <div className='min-h-[80px] flex flex-col h-full gap-3 p-3 text-sm font-semibold md:gap-0 md:flex-row md:items-center md:p-0 2xl:text-base whitespace-nowrap'>
